...
# samodurOFF 4 minutes ago
# А что, если в файле будут отрицательные индексы и самый маленький из них будет меньше, чем самый маленький отрицательный индекс из списка?